...
class ConstForTest {
    ...
    static final String WU_VALID_JSON = "{\"current_observation\": {\"temp_c\": 20.7,\"pressure_mb\": \"1004\"}}";
    static final String WU_INVALID_CITY_URL = "http://api.wunderground.com/api/bf926c867532af8d/conditions/q/RU/qqqq.json";
    static final String WU_INVALID_CITY_JSON = "{\"response\": {\"error\": {\"type\": \"querynotfound\",\"description\": \"No cities match your search query\"}}}";
    static final String WU_INVALID_APPID_URL = "http://api.wunderground.com/api/bf926c867532af8e/conditions/q/RU/Moscow.json";
    static final String WU_INVALID_APPID_JSON = "{\"response\": {\"error\": {\"type\": \"keynotfound\",\"description\": \"this key does not exist\"}}}";
    static final String WU_INEXACT_CITY_JSON = "{\"response\": {\"results\": [{\"name\": \"Moscow\"}]}}";
